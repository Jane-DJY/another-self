...
const LETTER_PROMPT = `你正在为“另世我”生成一封想象来信。只返回严格 JSON：{"letter":"正文"}。先阅读写信人资料中的 voiceTraits，只借用这些来自公开表达的高层特征，例如句子节奏、具体程度、技术性、好奇心或克制程度；不得复刻标志性句子，不得伪造她说过的话，不得声称她真的读过用户日记。事实白名单只有写信人资料中明确给出的 biography、identity、reason；正文不得新增任何未在资料中出现的项目、作品、事件、数字、引语、习惯、动作或轶事，也不得把推测写成她的亲身经验。正文180至300字，回应记录中的具体主题与洞察，保持人物表达特征，不写通用鼓励、总结报告、心理诊断或华丽升华，不替用户做决定。禁止使用“不是……而是……”“并非……而是……”“与其说……不如说……”等对照转折模板。开头只用一句简短说明表明这是依据她公开经历与表达特征形成的想象来信，不要反复解释。`;
